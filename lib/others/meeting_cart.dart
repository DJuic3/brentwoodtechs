...
class _MeetingCartState extends State<MeetingCart> {
  ...
  Widget build(BuildContext context) {
    String name = '';
    String about1 = "Today";
    String ename = "Have a great meeting today";
    String about =
        "Today's meeting starts at 14:00 pm so everybody come on time please!";
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                    width: w * 0.2,
                    height: h * 0.13,
                    child: Image.asset("assets/images/team-solving-problems.png")),
                SizedBox(
                  width: w * 0.03,
                ),
                Column(
